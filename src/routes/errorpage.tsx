    ...
    return (
        <Container className="error-page" maxWidth="sm">
            <Stack component="main" gap={3}>
                ...
                <Typography component="p">The link you were expecting did not lead to anywhere. Return to the home page <Link component={RouterLink} color="#658dae" to="/dashboard">here</Link>.</Typography>
                { 
                    error && 
